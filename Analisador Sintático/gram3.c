...
#define NREGRAS 4
#define NESTADOS 9
char alfabeto [NSIMBOLOS+1] = "(L)a,S#";
char *regras [NREGRAS] = 
{"S::=(L)",
"S::=a",
"L::=L,S",
...
int indice;
          ...
          { 
            'e',2, ' ',0, ' ',0, 'e',3, ' ',0, 'e',1, ' ',0,
            ' ',0, ' ',0, ' ',0, ' ',0, ' ',0, ' ',0, 'a',0,
            'e',2, 'e',4, ' ',0, 'e',3, ' ',0, 'e',5, ' ',0,
            'r',2, ' ',0, 'r',2, 'r',2, 'r',2, ' ',0, 'r',2,
            ' ',0, ' ',0, 'e',6, ' ',0, 'e',7, ' ',0, ' ',0,
            'r',4, ' ',0, 'r',4, 'r',4, 'r',4, ' ',0, 'r',4,
            'r',1, ' ',0, 'r',1, 'r',1, 'r',1, ' ',0, 'r',1,
            'e',2, ' ',0, ' ',0, 'e',3, ' ',0, 'e',8, ' ',0,
            'r',3, ' ',0, 'r',3, 'r',3, 'r',3, ' ',0, 'r',3,
          };
...
switch (acao) {
      ...
      case 'a': termino = 1;
                ...
                break;
      case ' ': printf ("\nA.sentenca%s>NAO_e_reconhecida", sentenca);
                printf("\n\nDigite '.' para terminar!\n\n"); 
                while (getchar()!='.');
                exit (1);
}
